...
export const defaultEditorSettings = {
  ...
  toolbar: 'uploadImageRu uploadVideoRu image media | undo redo | blocks | bold italic | alignleft aligncentre alignright alignjustify | indent outdent | bullist numlist | searchreplace code removeformat restoredraft',
